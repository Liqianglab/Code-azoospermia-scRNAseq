...
pB2_df <- read.csv("/Users/xq/Desktop/睾丸文章总/最新内容汇总/figure汇总/figure4/1.csv", header = TRUE, stringsAsFactors = FALSE)

#调整样本及cluster的顺序为指定顺序
cluster_order <- c("Sperm","Elongated_Spermatids","Round_Spermatids","Late_primary_SPCs","Early_primary_SPCs","SPGs","SSCs")
